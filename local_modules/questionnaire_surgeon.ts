...
const instructions = `The following is a snippet of HTML containing questions for a job application...`;
const system_prompt = `You are an expert in extracting queries from HTML, answering them according to the info below...`;
